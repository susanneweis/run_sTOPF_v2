...
def main(base_path, proj, nn_mi, atlas_path, roi_names):
    ...
    plot_top_sensitive_regions(res_df, results_data_out_path, nn_mi, top_n=50)
    plot_region_movie_profiles(coef_df, res_df, results_data_out_path, nn_mi, top_n=20)
    plot_movie_heatmap(coef_df, res_df, results_data_out_path, nn_mi, top_n=50)