...
def main(base_path, proj, movies_properties): 
    ...
    # Define the output directory
        ...
        #else:
        output_dir = f"{results_path}/results_PCA_all/{curr_mov}" # Local results directory
        ...
        if not os.path.exists(output_dir):
            ...
            roi_df.to_csv(f"{data_path}/ROI_names.csv", index=False)
    ...
    output_dir = f"{results_path}/results_PCA_all/concatenated_PCA" # Local results directory
    if not os.path.exists(output_dir):
